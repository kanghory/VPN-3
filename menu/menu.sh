...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/kanghory/permission/main/ipmini > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/kanghory/permission/main/ipmini | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/kanghory/permission/main/ipmini | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/kanghory/permission/main/ipmini | grep $MYIP | awk '{print $3}')
fi
...
export sem=$( curl -s https://raw.githubusercontent.com/kanghory/permission/main/versions)
...
echo -e "${BIYellow}□ License Limit       = ORDER ${GREEN}( 085225171738 )${NC}"
echo -e "${BIYellow}□ AutoScript By Dev   = Wak ${GREEN}( kanghoryTUNNELING )${NC}"

echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${BICyan} │                  ${BIWhite}${UWhite}KANG HORY TUNNELING${NC}"
echo -e "${BICyan} │"
echo -e " ${BICyan}│  ${BICyan}Use Core        :  ${BIPurple}XRAY${NC}"
echo -e " ${BICyan}│  ${BICyan}IP-VPS          :  ${BIYellow}$IPVPS${NC}"
echo -e " ${BICyan}└─────────────────────────────────────────────────────┘${NC}"

echo -e "${GREEN}ORANG YANG CERDAS YAITU YANG SELALU BERAMAL UNTUK AKHIRATNYA${NC}" 
...
13) clear ; slow ;;
99) clear ; clearcache ;;
6969) clear ; wget https://raw.githubusercontent.com/kanghory/VPN-3/main/update.sh && chmod +x update.sh && ./update.sh && rm -f /root/update.sh ;;
0) clear ; menu ;;
x) exit ;;

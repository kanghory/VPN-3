...
curl -sS https://raw.githubusercontent.com/kanghory/VPN-3/main/ssh/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/kanghory/VPN-3/main/ssh/nginx.conf"
mkdir -p /home/vps/public_html
/etc/init.d/nginx restart

# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/kanghory/VPN-3/main/ssh/newudpgw"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/kanghory/VPN-3/main/issue.net"
...
wget -O up "https://raw.githubusercontent.com/kanghory/VPN-3/main/up.sh"
chmod +x menu
chmod +x menu-trial
chmod +x menu-vmess
chmod +x menu-vless
